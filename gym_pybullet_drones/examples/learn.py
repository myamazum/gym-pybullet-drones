...
def run(multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO, local=True):
    ...
    if not multiagent:
        ...
        eval_env = Monitor(HoverAviary(obs=DEFAULT_OBS, act=DEFAULT_ACT))
    else:
        ...
        eval_env = Monitor(MultiHoverAviary(num_drones=DEFAULT_AGENTS, obs=DEFAULT_OBS, act=DEFAULT_ACT))
    ...
    if os.path.isfile(filename+'/best_model.zip'):
        ...
        path = filename+'/final_model.zip'
        print("[WARNING]: no best model found; loading the final model", path)
    ...
    if not multiagent:
        test_env = HoverAviary(gui=gui,
                               ...
                               act=DEFAULT_ACT,
                               record=record_video)
        test_env_nogui = Monitor(HoverAviary(obs=DEFAULT_OBS, act=DEFAULT_ACT))
    else:
